    ...
    <div data-scrollbar="true" data-height="100%">
        ...
        <ul class="nav">
            ...
            <li class="${id eq 'article' ? 'active' : ''}"><a href="${ctx}/front/article/index"><i class="fa fa-rocket"></i> <span>链接管理</span></a></li>
                <li class="${id eq 'balance' ? 'active' : ''}"><a href="${ctx}/front/balance/index"><i class="fa fa-rocket"></i> <span>余额查询</span></a></li>
                <li class="${id eq 'article-1' ? 'active' : ''}"><a href="${ctx}/front/article/index?type=1"><i class="fa fa-rocket"></i> <span>链接管理2</span></a></li>
                <li class="${id eq 'balance-1' ? 'active' : ''}"><a href="${ctx}/front/balance/index?type=1"><i class="fa fa-rocket"></i> <span>余额查询2</span></a></li>
