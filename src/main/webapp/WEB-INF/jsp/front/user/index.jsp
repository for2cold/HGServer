	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
		    ...
		    <div class="email-btn-row hidden-xs">
                <a href="${ctx}/front/user/add" class="btn btn-sm btn-success"><i class="fa fa-plus m-r-5"></i> 添加管理员</a>
            </div>
			<!-- begin row -->
			<div class="row">
			    <!-- begin col-12 -->
                                ...
                                <tbody>
                                    <c:if test="${page.hasContent}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <c:if test="${currentUser.id != item.id}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-danger m-b-0">
                        <h4><i class="fa fa-info-circle"></i> 您确定要删除该管理员吗？删除后不可恢复！</h4>
...
<script>
    $(document).ready(function() {
        ...
        $('#btn-remove').click(function() {
            ...
            var url = '${ctx}/front/user/' + id + '/remove';
