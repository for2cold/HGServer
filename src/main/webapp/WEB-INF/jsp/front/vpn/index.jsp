	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
		    ...
		    <div class="email-btn-row hidden-xs">
                <a href="${ctx}/front/vpn/add" class="btn btn-sm btn-success"><i class="fa fa-plus m-r-5"></i> 添加VPN</a>
            </div>
			<!-- begin row -->
			<div class="row">
			    <!-- begin col-12 -->
                                ...
                                <tbody>
                                    <c:if test="${page.hasContent}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <c:choose>
                                                    <c:when test="${item.status == 'IDLE'}">
                                                        <span class="label label-success">空闲</span>
                                                    </c:when>
                                                    <c:when test="${item.status == 'BUSY'}">
                                                        <span class="label label-warning">繁忙</span>
                                                    </c:when>
